...
pub struct RenderFrame {
    ...
    /// True if this frame is an IDR/keyframe (scene cut or decoder recovery point).
    /// Interpolation should be suppressed for frames immediately following a keyframe
    /// to avoid blending visually discontinuous content.
...
impl VideoToolboxDecoder {
    pub fn start_with_output(
        ...
        #[cfg(not(target_os = "macos"))]
        {
            ...
            bail!("yang video decode is only supported on macOS");
        }
